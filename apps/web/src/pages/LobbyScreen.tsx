    ...
    <div className="screen-lobby min-h-screen px-4 py-8 sm:px-6 lg:px-10">
      <div className="mx-auto max-w-6xl space-y-4">
        ...
        <section className="app-card p-5">
          ...
          <div className="mt-3 grid gap-3 text-sm text-slate-700 sm:grid-cols-2 xl:grid-cols-3">
            <div className="rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 rule-tile">
              <p className="font-semibold text-slate-900">1) How A Round Works</p>
              <div className="mt-1 space-y-1 leading-relaxed">
                <p>1. Proposer selects one option and submits.</p>
                <p>2. Counter selects one option and submits.</p>
                <p>3. Voters vote for proposer side or counter side.</p>
                <p>4. Reveal shows result and decides next round or game over.</p>
              </div>
            </div>

            <div className="rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 rule-tile">
              <p className="font-semibold text-slate-900">2) Voting Outcomes</p>
              <div className="mt-1 space-y-1 leading-relaxed">
            ...
            <div className="rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 rule-tile">
              <p className="font-semibold text-slate-900">3) Points System</p>
              <div className="mt-1 space-y-1 leading-relaxed">
                <p>Proposer/Counter manual pick: correct +4, wrong -4.</p>
                <p>Voter manual vote: correct +2, wrong -2.</p>
                <p>Tie round scoring: correct +1, wrong -1.</p>
                <p>Timeout auto-pick: fixed -2 for that action (not additive).</p>
              </div>
            </div>
